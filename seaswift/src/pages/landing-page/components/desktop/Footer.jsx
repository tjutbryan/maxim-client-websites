  ...
  return (
    <div className='footer1'>
      ...
      <div className='office-address1'>
        <div className='singapore-office1'>SEASWIFT TECHNOLOGIES LIMITED</div>
        ...
        ROOM 01 26TH FLOOR WORKING VIEW COMMERCIAL BUILDING 21 YIU WAH STREET CAUSEWAY BAY HONG KONG
        </div>
