...
const Footer = () => {
  return (
    <div className='footer1'>
      ...
      <div className='maxim-digital1'>Aimars Digital</div>
      <div className='office-address1'>
        ...
        <div className='taiwan-office1'>
          PT. Aimars Technology Indonesia Jl. Boulevard Raya Blok WD2 No.1,
          lantai 3., Kota Adm. Jakarta Utara, Prop. DKI Jakarta
        </div>
