...
const Footer = () => {
  return (
    <div className='footer1'>
      ...
      <div className='maxim-digital1'>COSAS LINDAS BAZAR S.R.L</div>
      <div className='office-address1'>
        <div className='singapore-office1'>Singapore Office</div>
        ...
        <div className='taiwan-office1'>
          Titular del Registro Notarial 1528 de la Ciudad Autonoma de Buenos
          Aires, Buenos Aires, Buenos Aires 1058, AR
        </div>
